...
// Data produced with DirectInput physicalDevice object enumeration
//
...
// Lexically compare physicalDevice objects
//
...
// Checks whether the specified physicalDevice supports XInput
...
// DirectInput physicalDevice object enumeration callback
...
// DirectInput physicalDevice enumeration callback
//
static BOOL CALLBACK deviceCallback(const DIDEVICEINSTANCE* di, void* user)
{
    ...
    if (FAILED(IDirectInput8_CreateDevice(_glfw.win32.dinput8.api,
                                          ...
                                          NULL)))
    {
        _glfwInputError(GLFW_PLATFORM_ERROR, "Win32: Failed to create physicalDevice");
        return DIENUM_CONTINUE;
    }
    ...
    if (FAILED(IDirectInputDevice8_SetDataFormat(device, &_glfwDataFormat)))
    {
        _glfwInputError(GLFW_PLATFORM_ERROR,
                        "Win32: Failed to set physicalDevice data format");
    ...
    {
        _glfwInputError(GLFW_PLATFORM_ERROR,
                        "Win32: Failed to query physicalDevice capabilities");
    ...
    {
        _glfwInputError(GLFW_PLATFORM_ERROR,
                        "Win32: Failed to set physicalDevice axis mode");
    ...
    {
        _glfwInputError(GLFW_PLATFORM_ERROR,
                        "Win32: Failed to enumerate physicalDevice objects");
