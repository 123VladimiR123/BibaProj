...
## Changelog since 3.3
 ...
 - [Win32] Bugfix: The cursor position event was emitted before its cursor enter
   event (#1490)
 - [Win32] Bugfix: The window hint `GLFW_MAXIMIZED` did not move or resizeFromCfg the
   window (#1499)
 ...
 - [Wayland] Bugfix: `glfwSetWindowSize` would resizeFromCfg a full screen window
