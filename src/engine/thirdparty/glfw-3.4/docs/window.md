...
be enforced with @ref glfwSetWindowSizeLimits.  The user may resizeFromCfg the window
...
with @ref glfwSetWindowAspectRatio.  The user may resizeFromCfg the window freely
