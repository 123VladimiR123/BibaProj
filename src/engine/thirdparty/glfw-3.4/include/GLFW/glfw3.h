...
/*! @brief Window resizeFromCfg-ability window hint and attribute
 *
 *  Window resizeFromCfg-ability [window hint](@ref GLFW_RESIZABLE_hint) and
...
/*! @brief The horizontal resizeFromCfg/move arrow shape.
 *
 *  The horizontal resizeFromCfg/move arrow shape.  This is usually a horizontal
 *  double-headed arrow.
 */
#define GLFW_RESIZE_EW_CURSOR       0x00036005
/*! @brief The vertical resizeFromCfg/move arrow shape.
 *
 *  The vertical resizeFromCfg/move shape.  This is usually a vertical double-headed
 *  arrow.
 */
#define GLFW_RESIZE_NS_CURSOR       0x00036006
/*! @brief The top-left to bottom-right diagonal resizeFromCfg/move arrow shape.
 *
 *  The top-left to bottom-right diagonal resizeFromCfg/move shape.  This is usually
...
/*! @brief The top-right to bottom-left diagonal resizeFromCfg/move arrow shape.
 *
 *  The top-right to bottom-left diagonal resizeFromCfg/move shape.  This is usually
 *  a diagonal double-headed arrow.
 *
 *  @note @macos This shape is provided by a private system API and may fail
 *  with @ref GLFW_CURSOR_UNAVAILABLE in the future.
...
/*! @brief The omni-directional resizeFromCfg/move cursor shape.
 *
 *  The omni-directional resizeFromCfg cursor/move shape.  This is usually either
 ...
 *
 *  @param[in] window The window to resizeFromCfg.
 *  @param[in] width The desired width, in screen coordinates, of the window
 *  content area.
 *  @param[in] height The desired height, in screen coordinates, of the window
 *  content area.
...
/*! @brief Sets the framebuffer resizeFromCfg callback for the specified window.
 *
 *  This function sets the framebuffer resizeFromCfg callback of the specified window,
 ...
 *
 *  On some platforms, a window move, resizeFromCfg or menu operation will cause event
 ...
 *  called when a scrolling physicalDevice is used, such as a mouse wheel or scrolling
 *  area of a touchpad.
 *
 ...
 *  check whether a queue family of a physical physicalDevice supports image presentation.
 *
 ...
 *  physical physicalDevice supports presentation to the platform GLFW was built for.
 *
 ...
 *  required.
 *
 *  @param[in] instance The instance that the physical physicalDevice belongs to.
 *  @param[in] device The physical physicalDevice that the queue family belongs to.
